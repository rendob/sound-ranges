...
export const SettingsButton: React.FC = () => {
  ...
  return (
    <>
      <button
        className="cursor-pointer p-2 transition-colors hover:bg-white/50"
        type="button"
        onClick={handleClick}
      >
        <svg
