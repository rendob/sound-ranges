...
type Props = { onInstrumentsMenuClick: () => void };

export const AppBar = ({ onInstrumentsMenuClick }: Props) => {
  return (
    <header css={styles.root}>
      <InstrumentsMenu onClick={onInstrumentsMenuClick} />
      Sound Ranges
    </header>
  );
};
...
const InstrumentsMenu = ({ onClick }: MenuProps) => {
  return (
    <svg
      width="24"
      height="24"
