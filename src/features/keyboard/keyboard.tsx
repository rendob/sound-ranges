...
function SingleKey(props: DisplayKey) {
  ...
  if (blackNums.includes(props.noteNum % 12)) {  // 黒鍵
  ...
  return (
    <g onMouseDown={(e) => handleMouseDown(e)} onMouseEnter={(e) => handleMouseEnter(e)}>
      <rect
        x={x} y="0"
        width={unitNoteWidth} height="50"
        fill={color}
        stroke="black"
      />
      { (props.noteNum % 12 === 0) &&
...
export function Keyboard() {
  ...
  return (
    <div className={styles.keyboard} onMouseDown={() => dispatch(clear())}>
